...
nifi_install_dir = os.path.join(stack_root, "current", "nifi-server")
...
nifi_ambari_ssl_config_version = config['nifi-ambari-ssl-config']['tag']
nifi_ambari_config_version = config['nifi-ambari-config']['tag']
